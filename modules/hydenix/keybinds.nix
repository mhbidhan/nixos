_: {
  hydenix.hm.hyprland.keybindings = {
    overrideConfig = ''
      ...
      bindd = $mainMod Alt, L, $d lock screen, exec, lockscreen.sh
      ...
      # bindd = ALT_R, Control_R,toggle waybar, exec, killall .waybar-wrapped || waybar # toggle waybar without reloading, this is faster

      $d=[$wm|Group Navigation]
      bindd = $mainMod Control, J, $d change active group backwards   , changegroupactive, b
      bindd = $mainMod Control, K, $d change active group forwards   , changegroupactive, f
